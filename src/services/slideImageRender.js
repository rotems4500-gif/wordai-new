 ...
 */
export const renderSlideToPng = async (slide, themeId, index = null, { pixelRatio = 2, bgOnly = false, deckTitle = '', format = 'png', quality = 0.85, fontCss = null, customTheme = null, deckId = '' } = {}) => {
  ...
  try {
    ...
    root.render(React.createElement(SlideStage, { slide, themeId, index, bgOnly, deckTitle, customTheme, deckId, forExport: true }));
    await nextFrame();
    await waitForFonts();
