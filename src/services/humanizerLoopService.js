...
const MARKER_REPAIR = {
  ...
  aiRegister: (d) => `יש ניסוחי מסגור והמלצה אופייניים ל-AI${d ? `: ${d}` : ''} — הימנע מ"ללא ספק", "מהווה סוגיה/אתגר", "היבט מרכזי", "ההמלצה/מומלץ", "מה שהופך/מאפשר". תבע את הטענה ישירות, בלי המסגור הכללי.`,
};
