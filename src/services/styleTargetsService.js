...
//     המשתמש כותב פסקה לכל משפט. **בפסקאות פרוזה בלבד: 3.59.** כלומר הכיוון
//     שהמדד הגולמי מכתיב הפוך מההרגל האמיתי, והמנוע (2.62) כותב פחות מדי
//     משפטים לפסקה ולא יותר מדי. לכן כאן היעד נגזר מפסקאות פרוזה בלבד.
