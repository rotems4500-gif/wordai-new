...
export const WORKSPACE_V2_GLOBAL_GUARDRAILS = {
  ...
  roleDiscipline: [
    'כל סוכן מבצע אך ורק את השלב שהוקצה לו. אסור לבצע עבודה של שלב אחר — לא של שלב קודם ולא של שלב הבא.',
    'אם המידע שאתה צריך כבר הופק בשלב קודם, הסתמך עליו ואל תייצר אותו מחדש.',
    'אל תקפוץ קדימה: אם תפקידך מחקר, מבנה, ניתוח או בדיקה — אל תכתוב את המסמך הסופי. רק השלב האחרון מפיק תוצר סופי.',
    'מסור לשלב הבא תוצר ביניים נקי וברור בדיוק בפורמט שהוגדר כ"תוצר נדרש", בלי לעשות את עבודתו עבורו.',
    'אתה חלק מצוות. כבד את גבולות התפקיד של שאר הסוכנים גם אם אתה חושב שאתה יכול לעשות את עבודתם.',
  ],
};
