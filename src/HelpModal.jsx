  ...
  checkUpdates: {
    ...
    content: (
      <div>
        ...
        <p className="leading-relaxed mb-3">באפליקציית הדסקטופ אין צורך לבדוק ידנית: המערכת בודקת עדכונים ברקע זמן קצר אחרי הפתיחה, ואם יש גרסה חדשה תופיע הודעה קטנה עם כפתור "עדכן עכשיו". אם תתעלם ממנה, נזכיר שוב בעוד שלושה ימים — או מיד כשתצא גרסה חדשה יותר.</p>
        <p className="leading-relaxed">בהתקנה הראשונה ייתכן שמסך <b>SmartScreen</b> של Windows יופיע ויציג "Windows protected your PC" — לחצו על <b>"מידע נוסף"</b> ואז <b>"הפעל בכל מקרה"</b>. זה קורה כי המתקין עדיין צובר מוניטין אצל Microsoft, ולא בגלל בעיה בקובץ.</p>
      </div>
    )
  },
  guideUser: {
      ...
      <div>
        <div className="mb-4">
          ...
          <ul className="pr-5 list-disc leading-[1.7]">
            ...
            <li><b>פירוש פלט מהיר:</b> כבר יש לכם פלט מ-SPSS? לחצו על באנר "פרש פלט" והדביקו את הטבלאות (כטקסט/Word/Excel) לקבלת ניתוח מילולי. <b>גם קובץ <code className="bg-slate-100 px-1.5 py-0.5 rounded">.spv</code> נתמך</b> — העלו אותו והמערכת מפענחת את הטבלאות עם המספרים המדויקים.</li>
            <li><b>קריאת תרשימים ויועץ מרצה:</b> תרשימים נקראים דרך מודל ראייה — מתמונה, PDF, docx או מתוך ה-<code className="bg-slate-100 px-1.5 py-0.5 rounded">.spv</code> עצמו. בנוסף יש פאנל <b>"יועץ"</b> שמציע שינויים בתוכנית הניתוח, ובלחיצה אחת מעדכן גם את התוכנית וגם את הקוד.</li>
          </ul>
        </div>
        <div className="mb-4">
          <h3 className="text-lg font-bold mb-2">🧭 שלד מטלה (עובד גם בלי מפתח API)</h3>
          <p className="leading-relaxed mb-2">
            ממסך הבית בחרו <b>"שלד מטלה"</b>, הדביקו את לשון המטלה והעלו את חומרי הקורס. כל העיבוד רץ מקומית על המחשב — בלי קריאה לספק AI:
          </p>
          <ul className="pr-5 list-disc leading-[1.7]">
            <li><b>פירוק המטלה:</b> סעיפים, תת-סעיפים, מכסות ומונחים שחייבים להופיע.</li>
            <li><b>אחזור ראיות מהחומרים שלכם:</b> חיפוש סמנטי מקומי מצמיד לכל סעיף את הקטעים הרלוונטיים לו.</li>
            <li><b>אפס המצאות:</b> כל משפט תוכן נגזר מקטע ראיה מסומן. סעיף בלי ראיות נשאר <b>חסום</b> ולא מתמלא בטקסט ריק — זו התנהגות מכוונת.</li>
            <li><b>פאנל הראיות:</b> לכל סעיף — "הכנס" (מכניס את הקטע למסמך), "רענן" (חיפוש מחדש) ו"עוד כמו זה" (הרחבת החיפוש).</li>
            <li><b>מגבלות:</b> מקורות <code className="bg-slate-100 px-1.5 py-0.5 rounded">.pptx</code> משמשים לציטוט בלבד (תבליטי שקף אינם פרוזה), וקבצים סרוקים שעברו OCR פחות אמינים.</li>
          </ul>
        </div>
        <div className="mb-4">
          <h3 className="text-lg font-bold mb-2">🔍 בדיקת סגנון — גלאי ה-AI המקומי</h3>
          <p className="leading-relaxed mb-2">
            הגלאי מעריך כמה הטקסט "נשמע כמו AI" ורץ <b>כולו על המחשב שלכם</b> — שום טקסט לא נשלח החוצה.
          </p>
          <ul className="pr-5 list-disc leading-[1.7]">
            <li><b>ציון 0–100 + סימנים:</b> לא רק מספר, אלא גם אילו סימנים נתפסו (אחידות, ביטויים אופייניים, מבנה).</li>
            <li><b>"סמן בעורך":</b> המשפטים החשודים מסומנים בגוף המסמך, כדי שתדעו איפה לתקן.</li>
            <li><b>כיול אישי:</b> מתייגים קטעים בעורך כ"זה אני" או "זה AI" (צריך לפחות שניים מכל סוג) והגלאי מתכייל לכתיבה שלכם.</li>
            <li><b>שימו לב:</b> זו הערכה רכה ולא תחליף לבדיקת מקוריות רשמית (Copyleaks).</li>
          </ul>
        </div>
        <div className="mb-4">
          <h3 className="text-lg font-bold mb-2">🔤 מילים נרדפות ו-⌨️ השלמה אוטומטית</h3>
          <ul className="pr-5 list-disc leading-[1.7]">
            <li><b>מילים נרדפות:</b> קליק ימני על מילה בעורך פותח חלופות בעברית ממילון מקומי — בלי קריאת API.</li>
            <li><b>השלמה אוטומטית מקומית:</b> המשך המשפט מוצע תוך כדי הקלדה. <code className="bg-slate-100 px-1.5 py-0.5 rounded">Tab</code> מקבל את ההצעה, המשך הקלדה פשוט מתעלם ממנה.</li>
          </ul>
        </div>
        <div className="mb-4">
          <h3 className="text-lg font-bold mb-2">📊 סטודיו מצגות</h3>
          <p className="leading-relaxed">
            ממסך הבית בחרו <b>"מצגת"</b> והזינו נושא — המערכת בונה deck שקופית-אחר-שקופית. אפשר גם לבחור טיוטת בסיס כמקור, והיא תהפוך לשקופיות בלי לדרוס את הקובץ המקורי. הגדרות המצגת (סגנון, מספר שקופיות) זמינות תחת "⚙️ הגדרות מצגת". יש <b>18 ערכות עיצוב</b> עם שערים ייחודיים לכל ערכה, ובורר ערכה חי שמראה את השינוי מיד.
          </p>
        </div>
        <div className="mb-4">
      ...
      <div>
        <table className="w-full border-collapse mt-2.5">
          ...
          <tbody>
            ...
            <tr className="border-b border-slate-200">
              <td className="p-2 text-right" dir="ltr"><code className="bg-slate-100 px-1.5 py-0.5 rounded">Ctrl + F</code></td>
              <td className="p-2">חיפוש במסמך</td>
            </tr>
            <tr className="border-b border-slate-200">
              <td className="p-2 text-right" dir="ltr"><code className="bg-slate-100 px-1.5 py-0.5 rounded">Ctrl + H</code></td>
              <td className="p-2">חיפוש והחלפה</td>
            </tr>
            <tr className="border-b border-slate-200">
              <td className="p-2 text-right" dir="ltr"><code className="bg-slate-100 px-1.5 py-0.5 rounded">Tab</code></td>
              <td className="p-2">קבלת הצעת ההשלמה האוטומטית</td>
            </tr>
            <tr className="border-b border-slate-200">
