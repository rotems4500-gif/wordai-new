// whole-work-harness.mjs — כתיבת עבודה שלמה בקריאה אחת, מול ספק אמיתי.
//
// הטענות שנבדקות:
...
const EV_S1 = [{
  ...
  text: 'שאלת המחקר נגזרה מן הוויכוח על עצמאות השיפוט מול הכניעה ללחץ חברתי. עד אז הונח שאדם בוגר שומר על שיפוטו כאשר העובדות ברורות לעין, ואש ביקש לבחון את ההנחה הזו בתנאי מעבדה מבוקרים.',
  score: 0.86,
}];
